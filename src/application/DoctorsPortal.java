...
public class DoctorsPortal {
	...
	private void handleLogIn(TextField doctorID, Stage stage) {
		...
		// For demonstration purposes, let's assume the login is successful and proceed
		// to the doctor's dashboard
	...
	private void showDoctorsDashboard(Stage stage) {
		...
		Tab visitHistoryTab = new Tab("Patient Visit History");
		...
		Tab medicalRecordTab = new Tab("Patient Medical Record");
